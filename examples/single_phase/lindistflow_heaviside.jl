...
#
#  Run:  julia --project=examples/single_phase examples/single_phase/lindistflow_heaviside.jl
# =====================================================================================

using SmartInverterDOPF, Ipopt, Printf

case = load_case()

res = solve_dopf(case, Ipopt.Optimizer;
                 method     = :heaviside,
                 host       = :lindistflow,
                 attributes = Dict{String,Any}("max_iter" => 3000, "print_level" => 0))
